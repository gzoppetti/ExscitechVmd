...
#       $Revision: 1.43 $        $Date: 2009/05/16 04:58:42 $
#
############################################################################
#
# VMD save state $Revision: 1.43 $
#
#
...
proc save_state {{file EMPTYFILE}} {
  ...
  puts $fildes "\# VMD script written by save_state \$Revision: 1.43 $"
...
proc save_materials { filedes } {
  ...
  for { set i 0 } { $i < [llength $mlist] } { incr i } {
    ...
    lassign [material settings $mat] amb spec dif shin opac outl outlw
