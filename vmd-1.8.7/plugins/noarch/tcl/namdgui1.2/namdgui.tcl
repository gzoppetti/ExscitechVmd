...
proc ::NAMDgui::namdgui_gui {} {
   ...
   $w.menu.edit add command -label "Ensemble" -accelerator <Ctrl-e> -command {::NAMDgui::ensemble_gui}
   $w.menu.edit add command -label "Fixed atoms" -accelerator <Ctrl-f> -command {::NAMDgui::fixedatoms_gui}
