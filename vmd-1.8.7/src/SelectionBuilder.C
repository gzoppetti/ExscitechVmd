 ...
 *      $Revision: 1.25 $       $Date: 2009/05/28 21:15:16 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
: Fl_Group(xpos, ypos, 300, 280, "Selections") 
{
  menu = m;
  selectiontext = input;
  mol = NULL;
  ...
  goto_end = 0;
    ...
    { Fl_Browser* o = keywordbrowser = new Fl_Hold_Browser(xpos+15, ypos+180, 135, 100, "Keyword");
      o->color(VMDMENU_BROWSER_BG);
      o->selection_color(VMDMENU_BROWSER_SEL);
      o->align(FL_ALIGN_TOP);
      o->callback(keyword_cb, this);
    }
    { Fl_Browser* o = valuebrowser = new Fl_Hold_Browser(xpos+165, ypos+180, 135, 100, "Value");
      o->color(VMDMENU_BROWSER_BG);
      o->selection_color(VMDMENU_BROWSER_SEL);
      o->align(FL_ALIGN_TOP);
