 ...
 *	$Revision: 1.64 $	$Date: 2009/04/29 15:42:50 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
//////////////////////////  constructor
Axes::Axes(DisplayDevice *d, Displayable *par) 
...
void Axes::create_cmdlist(void) {
  ...
  txt.putdata(xText, "x", cmdList);
  txt.putdata(yText, "y", cmdList);
  txt.putdata(zText, "z", cmdList);
