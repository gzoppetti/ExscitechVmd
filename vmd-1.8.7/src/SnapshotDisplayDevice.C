 ...
 *	$Revision: 1.41 $	$Date: 2009/04/29 15:43:23 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
#define DEF_SNAPSHOT_FILENAME "snap.bmp"
#else
#define DEF_SNAPSHOT_FILENAME "snap.tga"
#endif

SnapshotDisplayDevice::SnapshotDisplayDevice(DisplayDevice *d) 
: FileRenderer("snapshot", DEF_SNAPSHOT_FILENAME, DEF_VMDIMAGEVIEWER) {
  display = d; 
