 ...
 *	$Revision: 1.40 $	$Date: 2009/04/29 15:43:21 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
: FileRenderer("Radiance","plot.rad", 
...
// draw a single radius cone
void RadianceDisplayDevice::cone(float *a, float *b, float r) {
  cone(a, b, r, 0.0);
}

// draw a two radius cone
void RadianceDisplayDevice::cone(float *a, float *b, float rad1, float rad2) {
