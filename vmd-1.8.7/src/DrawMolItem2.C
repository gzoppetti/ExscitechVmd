 ...
 *	$Revision: 1.31 $	$Date: 2009/04/29 15:43:00 $
 *
 ***************************************************************************
 * DESCRIPTION:
          ...
          if (flgs[a]) {
            ...
            while (offset < num_edges && edges[2*offset] == a) {
              ...
              if (flgs[b]) {
                ...
                verts.append(xyz[0][0]);
                verts.append(xyz[0][1]);
                verts.append(xyz[0][2]);
                verts.append(xyz[1][0]);
                verts.append(xyz[1][1]);
                verts.append(xyz[1][2]);
              }
              offset++;
            }
          } else {
