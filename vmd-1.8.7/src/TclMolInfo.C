 ...
 *	$Revision: 1.83 $	$Date: 2009/07/28 21:58:51 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
//    generic_molinfo_qm_arr("%d", "shell_symmetry", shell_symmetry, mol->qm_data->num_basis);
...
//    generic_molinfo_qm_arr("%.6f", "basis_array", basis_array, 2*mol->qm_data->num_basis);
    ...
    //generic_molinfo_qm_arr("%.6f", "esp_charges", esp_charges, mol->nAtoms);
#endif
