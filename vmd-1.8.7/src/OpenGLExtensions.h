 ...
 *	$Revision: 1.44 $	$Date: 2009/05/04 21:42:16 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
#if 0 && defined(GL_ARB_shader_objects)
...
#if defined(_MSC_VER) || defined(MINGW) || defined(__APPLE__) || defined(__irix) || (!defined(ARCH_SOLARIS2) && !defined(ARCH_SOLARIS2_64))
...
public: 
  ...
  int hasmesharraysun;           ///< glDrawMeshArraysSUN
...
//
  ...
  enum rendenum { SUNZULU, SUNFFB3, SUNELITE3D, SUNEXPERT3D,
                  ATI, NVIDIA, SGIIR, MSOFTGDI, MESAGL, WIREGL, GENERIC };
