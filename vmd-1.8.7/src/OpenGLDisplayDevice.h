 ...
 *	$Revision: 1.49 $	$Date: 2009/04/29 15:43:12 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
#if !defined(_MSC_VER) && !defined(MINGW) && !(defined(VMDSDL) && defined(__APPLE__))
#include <GL/glx.h>
...
public:
  VMDApp *vmdapp; // cached VMDApp pointer for use by drag-and-drop handlers
