 ...
 *      $Revision: 1.38 $      $Date: 2009/04/29 15:43:39 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
static char * vmd_get_vmddir(void) {
  ...
  res = RegOpenKeyEx(HKEY_LOCAL_MACHINE, 
                     "Software\\University of Illinois\\VMD\\1.8.7",
                     0,
                     KEY_READ,
                     &k);
...
/* XXX WIN64 registry hacks */
  ...
  if (res != ERROR_SUCCESS) {
    ...
    res = RegOpenKeyEx(HKEY_LOCAL_MACHINE, 
                       "Software\\WOW6432node\\University of Illinois\\VMD\\1.8.7",
                       0,
                       KEY_READ,
                       &k);
  }
...
#endif
  fprintf(stderr, "win32vmdstart defined!\n");
  int i, j, len;
