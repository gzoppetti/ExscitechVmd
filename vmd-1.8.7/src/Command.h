 ...
 *    $Revision: 1.165 $    $Date: 2009/07/21 06:04:10 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
public:
  ...
  enum Cmdtype { 
    ...
    DISP_RESETVIEW, DISP_STEREO, DISP_CACHEMODE, DISP_RENDERMODE, 
    ...
    INTERP_EVENT,
    LABEL_ADD, LABEL_ADDSPRING, LABEL_SHOW, LABEL_DELETE, LABEL_TEXTSIZE,
    LABEL_TEXTOFFSET, LABEL_TEXTFORMAT,
