 ...
 *	$Revision: 1.93 $	$Date: 2009/05/04 22:07:09 $
 *
 ***************************************************************************
 * DESCRIPTION:
 *
...
typedef void * vmd_timerhandle;            ///< a timer handle
vmd_timerhandle vmd_timer_create(void);    ///< create a timer (clears timer)
void vmd_timer_destroy(vmd_timerhandle);   ///< create a timer (clears timer)
void vmd_timer_start(vmd_timerhandle);     ///< start a timer  (clears timer)
void vmd_timer_stop(vmd_timerhandle);      ///< stop a timer                 
double vmd_timer_time(vmd_timerhandle);    ///< report elapsed time in seconds
double vmd_timer_timenow(vmd_timerhandle); ///< report elapsed time in seconds
...
extern msgtimer * msg_timer_create(double updatetime);

/// return true if it's time to print a status update message
extern int msg_timer_timeout(msgtimer *time);
...
#if defined(__linux) || defined(_MSC_VER) || defined(MINGW)
