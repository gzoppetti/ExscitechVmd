 ...
 *      $Revision: 1.57 $       $Date: 2009/04/29 15:43:09 $
 *
 ***************************************************************************
 * DESCRIPTION:
...
// Setting the unitsdebye flag to 1 will scale the results by 4.77350732929 (default 0)
// For charged systems the point of reference for computing the dipole is
// selected with usecenter: 1 = geometrical center, -1 = center of mass, 0 = origin (default 1)
