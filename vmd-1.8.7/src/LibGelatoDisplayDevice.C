...
*      $Revision: 1.9 $         $Date: 2009/04/29 15:43:07 $
*
***************************************************************************
* DESCRIPTION:
*
...
: FileRenderer("GelatoInternal","plot.tif", DEF_VMDIMAGEVIEWER) {
...
/// XXX disabled until there's time to dig into the docs further
///     we'll fall back to triangulated geometry for now
#if 0
/// draw a cylinder
void LibGelatoDisplayDevice::cylinder(float *a, float *b, float r, 
                              int /* filled */ ) {
}


/// draw a cone
void LibGelatoDisplayDevice::cone(float *a, float *b, float r) {
}
#endif  /// XXX end of disabled methods
...
void LibGelatoDisplayDevice::trimesh(int numverts, float * cnv,
