...
#      $Revision: 1.5 $      $Date: 2009/07/07 16:18:41 $
#
############################################################################
...
# ---------------------------------------------------------------------------
   ...
   proc showEditNotesDialog {parent a_sequenceID} {
      ...
      grid $w.center.calcss         -column 1 -row 13 -sticky e
      ...
      $w.center.ecd insert 0 [::SeqData::getEnzymeCommisionDescription \
                                                             $sequenceID]
...
# ---------------------------------------------------------------------------
   proc but_ok {} {
      ...
      if {[$w.center.ec get] != \
                           [::SeqData::getEnzymeCommisionNumber $sequenceID]} {
      ...
      if {[$w.center.ec get] == "" && \
          [$w.center.ecd get] != [::SeqData::getEnzymeCommisionDescription \
                                                               $sequenceID]} {
