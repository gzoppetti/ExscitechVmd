...
/*
 * $Header: /home/cvs/vmd/cvsroot/plugins/hesstrans/src/hesstrans_wrap.C,v 1.2 2006/08/01 18:34:02 johns Exp $
 * 
 * swigtcl8.swg
 */
...
#define SWIG_init    Hesstrans_Init
#define SWIG_name    "hesstrans"
#define SWIG_prefix  ""
...
/*
 * Why is there a main() routine in here???
 */
...
#endif
static int
_wrap_getInternalHessian(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    ...
    if (SWIG_GetArgs(interp, objc, objv,"oooiiiii:getInternalHessian doubleArray intArray hessianInternal numCartesians numBonds numAngles numDihedrals numImpropers ",0,0,0,&arg4,&arg5,&arg6,&arg7,&arg8) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[2], (void **) &arg2, SWIGTYPE_p_int,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[3], (void **) &arg3, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    result = (int)getInternalHessian(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
static int
_wrap_new_Real(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    Real *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"i:new_Real size ",&arg1) == TCL_ERROR) SWIG_fail;
    result = (Real *)new_Real(arg1);
    
    Tcl_SetObjResult(interp,SWIG_NewInstanceObj((void *) result, SWIGTYPE_p_Real,0));
    return TCL_OK;
    fail:
    return TCL_ERROR;
}
...
static int
_wrap_delete_Real(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    Real *arg1 = (Real *) 0 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"o:delete_Real a ",0) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_Real,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    delete_Real(arg1);
...
static int
_wrap_get_Real(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    Real *arg1 = (Real *) 0 ;
    int arg2 ;
    Real result;
    
    if (SWIG_GetArgs(interp, objc, objv,"oi:get_Real a index ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_Real,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    result = get_Real(arg1,arg2);
    
    {
        Real * resultptr;
        resultptr = new Real((Real &) result);
        Tcl_SetObjResult(interp,SWIG_NewInstanceObj((void*) resultptr, SWIGTYPE_p_Real,1));
    }
    return TCL_OK;
    fail:
    return TCL_ERROR;
...
static int
_wrap_set_Real(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    Real *arg1 = (Real *) 0 ;
    int arg2 ;
    Real arg3 ;
    Real *argp3 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oio:set_Real a index val ",0,&arg2,0) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_Real,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[3], (void **) &argp3, SWIGTYPE_p_Real,SWIG_POINTER_EXCEPTION ) != TCL_OK)) SWIG_fail;
    arg3 = *argp3; 
    set_Real(arg1,arg2,arg3);
...
static int
_wrap_new_int(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    int *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"i:new_int size ",&arg1) == TCL_ERROR) SWIG_fail;
    result = (int *)new_int(arg1);
    
    Tcl_SetObjResult(interp,SWIG_NewInstanceObj((void *) result, SWIGTYPE_p_int,0));
    return TCL_OK;
    fail:
    return TCL_ERROR;
}
...
static int
_wrap_delete_int(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int *arg1 = (int *) 0 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"o:delete_int a ",0) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_int,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    delete_int(arg1);
...
static int
_wrap_get_int(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int *arg1 = (int *) 0 ;
    int arg2 ;
    int result;
    
    if (SWIG_GetArgs(interp, objc, objv,"oi:get_int a index ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_int,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    result = (int)get_int(arg1,arg2);
...
static int
_wrap_set_int(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int *arg1 = (int *) 0 ;
    int arg2 ;
    int arg3 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oii:set_int a index val ",0,&arg2,&arg3) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_int,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    set_int(arg1,arg2,arg3);
...
static int
_wrap_check_int(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int *arg1 = (int *) 0 ;
    int arg2 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oi:check_int a size ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_int,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    check_int(arg1,arg2);
...
static int
_wrap_new_double(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    int arg1 ;
    double *result;
    
    if (SWIG_GetArgs(interp, objc, objv,"i:new_double size ",&arg1) == TCL_ERROR) SWIG_fail;
    result = (double *)new_double(arg1);
    
    Tcl_SetObjResult(interp,SWIG_NewInstanceObj((void *) result, SWIGTYPE_p_double,0));
    return TCL_OK;
    fail:
    return TCL_ERROR;
}
...
static int
_wrap_delete_double(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    double *arg1 = (double *) 0 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"o:delete_double a ",0) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    delete_double(arg1);
...
static int
_wrap_get_double(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    double *arg1 = (double *) 0 ;
    int arg2 ;
    double result;
    
    if (SWIG_GetArgs(interp, objc, objv,"oi:get_double a index ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    result = (double)get_double(arg1,arg2);
...
static int
_wrap_set_double(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    double *arg1 = (double *) 0 ;
    int arg2 ;
    double arg3 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oid:set_double a index val ",0,&arg2,&arg3) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    set_double(arg1,arg2,arg3);
...
static int
_wrap_check_double(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    double *arg1 = (double *) 0 ;
    int arg2 ;
    
    if (SWIG_GetArgs(interp, objc, objv,"oi:check_double a size ",0,&arg2) == TCL_ERROR) SWIG_fail;
    if ((SWIG_ConvertPtr(objv[1], (void **) &arg1, SWIGTYPE_p_double,SWIG_POINTER_EXCEPTION | 0) != TCL_OK)) SWIG_fail;
    check_double(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "getInternalHessian", (swig_wrapper_func) _wrap_getInternalHessian, NULL},
    { SWIG_prefix "new_Real", (swig_wrapper_func) _wrap_new_Real, NULL},
    { SWIG_prefix "delete_Real", (swig_wrapper_func) _wrap_delete_Real, NULL},
    { SWIG_prefix "get_Real", (swig_wrapper_func) _wrap_get_Real, NULL},
    { SWIG_prefix "set_Real", (swig_wrapper_func) _wrap_set_Real, NULL},
    { SWIG_prefix "new_int", (swig_wrapper_func) _wrap_new_int, NULL},
    { SWIG_prefix "delete_int", (swig_wrapper_func) _wrap_delete_int, NULL},
    { SWIG_prefix "get_int", (swig_wrapper_func) _wrap_get_int, NULL},
    { SWIG_prefix "set_int", (swig_wrapper_func) _wrap_set_int, NULL},
    { SWIG_prefix "check_int", (swig_wrapper_func) _wrap_check_int, NULL},
    { SWIG_prefix "new_double", (swig_wrapper_func) _wrap_new_double, NULL},
    { SWIG_prefix "delete_double", (swig_wrapper_func) _wrap_delete_double, NULL},
    { SWIG_prefix "get_double", (swig_wrapper_func) _wrap_get_double, NULL},
    { SWIG_prefix "set_double", (swig_wrapper_func) _wrap_set_double, NULL},
    { SWIG_prefix "check_double", (swig_wrapper_func) _wrap_check_double, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Real[] = {{"_p_Real", 0, "Real *", 0},{"_p_Real"},{0}};
...
SWIGEXPORT(int) Hesstrans_SafeInit(Tcl_Interp *interp) {
