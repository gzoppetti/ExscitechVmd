...
#
# $Id: solvate.tcl,v 1.52 2009/08/01 05:26:07 johns Exp $
#
...
package require psfgen 1.4
package provide solvate 1.3
...
# Set some defaults
  ...
  if { [string length $segstrcheck] > 4 } {
    set usehex 1
    vmdcon -warn "Warning: use of decimal numbering would overrun segname field size"
    vmdcon -warn "Warning: using hexadecimal numbering instead..."
    puts $logfile "Warning: use of decimal numbering would overrun segname field size"
    puts $logfile "Warning: using hexadecimal numbering instead..."
  } 
